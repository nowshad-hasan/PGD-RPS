<%-- 
    Document   : student
    Created on : Feb 8, 2017, 9:08:42 AM
    Author     : nowshad
--%>
        ...
        <div class="container">
            ...
            <c:choose>
                <c:when test="${empty students}">
                    ...
                    <p style="color:white">Nothing to show.Please select session for students info</p>
                    <br />
                </c:when>    
                <c:otherwise>
                        ...
                        <tbody>
                            <c:forEach items="${students}" var="student">
                                <tr>
                                    ...
                                    <td>
                                        <form
                                            method="post" action="IndividualResultServlet">


                                            <button class="btn btn-primary" type="submit" name="studentID" value="${student.getStudentID()}">Full Result</button>
                                        </form>
                                    </td>
                                </tr>
                            </c:forEach>
