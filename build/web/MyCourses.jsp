<%-- 
    Document   : MyCourses
    Created on : Mar 28, 2017, 9:48:18 AM
                ...
                <tbody>
                    <c:forEach items="${myCourses}" var="course">
                        <tr>
                            ...
                            <td><c:out value="${course.getCourseSessionYear()}"/> </td>
                            <td><c:out value="${course.getCourseCredit()}" /></td>
                            <td><c:out value="${course.getCourseSemester()}"/> </td>
                            <td>
                                <div class="button-container">
                                    <form method="get" action="ResultInfoServlet" > 

                                        <input type="hidden" name="actionName" value="editResultPersonal" />
                                        <button type="submit" name="registrationID" class="btn btn-primary" value="${course.getRegistrationID()}">Edit Result</button>
                                    </form>
                                    <form method="get" action="ResultInfoServlet">

                                        <input type="hidden" name="actionName" value="showResultPersonal" />
